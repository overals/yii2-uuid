...
use p2made\Uuid\Console\Util\BufferedOutput;
...
class DecodeCommandTest extends TestCase
{
	...
	protected function setUp()
	{
		...
		$this->decode->setApplication(new \p2made\Uuid\Console\Application());
	}

	/**
	 * @covers p2made\Uuid\Console\Command\DecodeCommand::configure
	 */
	...
	/**
	 * @covers p2made\Uuid\Console\Command\DecodeCommand::execute
